...
<!-- Fuente: https://github.com/lottiefiles/motion-design-skill (MIT, LottieFiles). Copia literal con director/, patterns/ y reference/. Criterio de movimiento, agnóstica de librería: vale para CSS vanilla. -->
