...
<!-- Fuente: https://github.com/vercel-labs/open-agents/tree/main/.agents/skills/web-animation-design (Vercel). Copia literal con PRACTICAL-TIPS.md. Reglas concretas de easing, duración y rendimiento; vale para CSS vanilla. -->
